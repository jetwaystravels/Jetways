        ...
        public async Task<IActionResult> FlightSameAirline(string flightclass, string SameAirlineRT)
        {
            ...
            else
            {
                ...
                using (HttpClient client = new HttpClient())
                {
                    ...
                    //    //_SimpleAvailabilityobjR.origin = _GetfligthModel.origin;
                    //    //_SimpleAvailabilityobjR.destination = _GetfligthModel.destination;
                    //    //_SimpleAvailabilityobjR.beginDate = _GetfligthModel.beginDate;
                    //    //_SimpleAvailabilityobj.endDate = _GetfligthModel.endDate;
