...
namespace OnionArchitectureAPI.Services.Spicejet
{
    public class _GetSSR
    {
        ...
        public async Task<GetSSRAvailabilityForBookingResponse> GetSSRAvailabilityForBooking(string Signature, AirAsiaTripResponceModel passeengerlist, int TotalCount, string _journeySide, string _AirlineWay = "")
        {
