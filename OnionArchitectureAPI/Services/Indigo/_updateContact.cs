...
namespace OnionArchitectureAPI.Services.Indigo
{
    public class _updateContact:ControllerBase
    {
        ...
        Logs logs = new Logs();
        public async Task<UpdateContactsResponse> GetUpdateContacts(string Signature, string emailAddress,string _AirLineWay="")
        {
            ...
            _ContactModel6E.updateContactsRequestData.BookingContactList[0].CompanyName = "Indigo";
            _ContactModel6E.updateContactsRequestData.BookingContactList[0].CustomerNumber = ""; //GSTNumber Re_ Assistance required for SG API Integration\GST Logs.zip\GST Logs
