        ...
        public async Task<IActionResult> booking()
        {
            ...
            if (!string.IsNullOrEmpty(tokenview))
            {
                ...
                using (HttpClient client1 = new HttpClient())
                {
                    ...
                    //getdetails
                    string strResponse = _objAvail.RetrivePnr( RecordLocator, _testURL,  newGuid.ToString(), _targetBranch, _userName, _password,  "GDSOneWay");

                    //GetAirTicket

                    string strAirTicket = _objAvail.GetTicketdata(RecordLocator, _testURL, newGuid.ToString(), _targetBranch, _userName, _password, "GDSOneWay");
