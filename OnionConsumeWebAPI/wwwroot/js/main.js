...
var countries = ["Ludhiana-LUH", "Pathankot-IXP", "Bathinda-BUP", "Pondicherry-PNY", "Jeypore-PYB", "Jharsuguda-JSA", "Dimapur-DMU", "Aizawl-AJL", "Shillong-SHL", "Akola-AKD", "Jalgaon-JLG", "Solapur-SSL", "Aurangabad-IXU", "Kolhapur-KLH", "Nanded-NDC", "Yavatmal-YTL", "Nashik-ISK", "Shirdi-SAG", "Indore-IDR", "Gwalior-GWL", "Bhopal-BHO", "Jabalpur-JLR", "Satna-TNI", "Khajuraho-HJR", "Agatti-AGX", "Hubli-HBX", "Mysore-MYQ", "Belgaum-IXG", "Bellary-BEP", "Ranchi-IXR", "Jamshedpur-IXW", "Bokaro-BKR", "Shimla-SLV", "Kangra-DHM", "Hisar-HSS", "Bhavnagar-BHU", "Rajkot-RAJ", "Porbandar-PBD", "Jamnagar-JGA", "Kandla-IXY", "Vadodara-BDQ", "Silchar-IXS", "Tezpur-TEZ", "North Lakhimpur-IXI", "Jorhat-JRH", "Dibrugarh-DIB", "Diu-DIU", "Raipur-RPR", "Bilaspur-PAB", "Gaya-GAY", "Pasighat-IXT", "Tirupati-TIR", "Mysore-MYQ", "Muzaffarpur-MZU", "Mohanbari-MOH", "Mangalore-IXE", "Malda-LDA", "Madurai-IXM", "Coimbatore-CJB", "Chandigarh-IXC", "Car Nicobar-CBD", "Mumbai-BOM", "Bilaspur-PAB", "Bikaner Airport-BKB", "Bhuj-BHJ", "Bhubaneswar-BBI", "Bhopal-BHO", "Bhavnagar-BHU", "Bhatinda-BUP", "Bellary-BEP", "Belgaum-IXG", "Bareli-BEK", "Balurghat-RGH", "Bagdogra-IXB", "Aurangabad-IXU", "Amritsar-ATQ", "Along-IXV", "Allahabad-IXD", "Akola-AKD", "Agartala-IXA", "Agra-AGR", "Ahmedabad-AMD", "Aizawl-AJL", "Jammu-IJX", "Bangalore-BLR", "Calcutta (Kolkata)-CCU", "Delhi-DEL", "Mumbai-BOM", "Pune-PNQ"];
